...
public class Main {
    public static void main(String[] args) {
        ...
        createAndAddNewCustomer(customers, "New Customer", LocalDate.now());
    ...
    private static void createAndAddNewCustomer(List<Customer> customers, String name, LocalDate registrationDate) {
        Customer newCustomer = new Customer(name, registrationDate);
    ...
    private static List<Customer> initializeCustomers() {
        ...
        Customer customer1 = new Customer("Ali", LocalDate.of(2024, 1, 15));
        Customer customer2 = new Customer("Ayşe", LocalDate.of(2024, 6, 10));
        Customer customer3 = new Customer("Mehmet", LocalDate.of(2024, 3, 5));
